...
////////////////////////////////////////////////////////////////////////////
class QTrackerDirectDriverConnectionOpen : public QRunnable
{

public:
    QTrackerDirectDriverConnectionOpen(QTrackerDirectDriverPrivate *d) : d(d), runFinished(0), runSemaphore(1) { setAutoDelete(false); }
