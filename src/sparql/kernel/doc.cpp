/*!
    ...
    The query model can then be used in the same way, by calling QSparqlQueryModel::setQuery().
    The example <i>qmlquerymodel</i> shows how to use the model with the
